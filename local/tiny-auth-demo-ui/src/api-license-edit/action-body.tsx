...
/** */
export type ApiItemValidation = { validation: ValidationResultMap<ApiItem>, isValidationEmpty: boolean };
/** */
...
/** */
class ActionBody extends Component<ActionBodyProps & { classes: ClassNameMap }, ActionBodyState> {
    state = {
        formData: {} as any,
    }

    static getDerivedStateFromProps(props: ActionBodyProps, state: ActionBodyState) {
        const { item } = props;
                ...
                render={(validationState) => {
                    ...
                    return <>
                        ...
                        <div style={{ display: "flex", justifyContent: "flex-end", marginTop: "1rem", }}>{
                            this.props.render && this.props.render({ validation, isValidationEmpty, formData })
                        }</div>
                    </>
                }} />
        </div>)
