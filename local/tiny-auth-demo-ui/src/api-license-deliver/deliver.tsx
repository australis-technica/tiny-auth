...
export default class Deliver extends Component<DeliverProps & { classes: ClassNameMap }>{
    state = {
    ...
    deliver = async () => {
        try {
            ...
            await this.props.api.deliver(this.props.item.id);
            this.props.onClose();
        } catch (error) {
            this.setState({
                error: error.message
    ...
    render() {
        ...
        return <Dialog open={isOpen} onClose={onClose}>
            ...
            <DialogActions className={classes.dialogActions}>
                ...
                <Button className={classes.buttonOk} disabled={busy}
                    variant="raised"
                    onClick={this.deliver}>OK</Button>
            </DialogActions>
        </Dialog >
    }
}