...
/** */
type ViewProps = LoginViewProps & RouteComponentProps<{}> & { classes: ClassNameMap, dispatch: Dispatch, };
/** */
 ...
 *
 */
const Connected: React.ComponentType<{ image: any, auth: Auth }> = connect(selector)(LoginView);
/** */
